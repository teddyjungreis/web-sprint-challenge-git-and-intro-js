...
let firstArtistName = artists[0].name;
console.log(firstArtistName);


//(2) Bio of the third artist (2nd index) in the array 

let thirdArtistBio = artists[2].bio;
...
function getArtistByIndex(array, index ) {
  ...
  let artistString = `the artist at index ${index} is ${artistName}`;
  return (artistString);
}
...
2. Receive a string (name), a string (years), a string (genre), a string (nationality), and a string (bio) as arguments passed from the SECOND, THIRD, FOURTH, FIFTH, and SIXTH parameters, respectively.
...
//console.log(addArtist(artists, 'John Doe', '1988-2022', 'Full Stack Development', 'African American', 'I have a background in CS.'));
